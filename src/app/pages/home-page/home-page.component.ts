...
export class HomePageComponent {
  ...
  public processing(): void {
    const queryFileName = this.store.properties[0].queryFile.trim();
    ...
    this.store.updateCurrentTab(this.store.properties.find(x => x.queryFile === queryFileName) ?? this.store.properties[0])
  }
